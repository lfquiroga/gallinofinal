...
class Route
{
    ...
    /** @var string  La acciÃ³n del Controller a ejecutar. Ej: "PeliculaController@index" */
    ...
    /**
     * Registra una ruta en la aplicaciÃ³n.
     *
     * @param string $method    El verbo HTTP de la ruta. Puede ser 'GET', 'POST', 'PUT', 'DELETE'.
     * @param string $url   La url de la ruta.
     * @param string $controller    El método del controller que lo va a manejar. La notaciÃ³n es: "NombreController@nombreMétodo".
     */
