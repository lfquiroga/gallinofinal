...
<div class="container">
  <h2 class="titlesection">Ultimas agregadas</h2>
  <?php
    $contador = 1;
...
?>
  <div class="row">
    <div class="col-md-12"><a class="vermasbutton btncenterblq" href="<?= \cafeterias\Core\App::urlTo('/todas') ?>">Ver todas<i class="fawincon fa fa-plus" aria-hidden="true"></i></a></div>
  </div>
  <hr class="htstyle">
