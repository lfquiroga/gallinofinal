    ...
    <div class="col-lg-6 col-sm-6">
      <form method="post" action="<?= \cafeterias\Core\App::urlTo('/eventos/cargar'); ?>"  enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="nombre" id="nombre" value="<?php if (isset($_old_input['nombre'])) {  echo($_old_input['nombre']);  } ?>" class="form-control"/> <p><?php if (isset($_errors['nombre'][0])) { echo($_errors['nombre'][0]);  }?> </p>
        </div>

        <div class="form-group">
          <label for="direccion">Titulo</label>
          <input type="text" name="titulo" id="titulo" value="<?php if (isset($_old_input['titulo'])) {echo($_old_input['titulo']);  } ?>" class="form-control"/> <p><?php  if (isset($_errors['titulo'][0])) {echo($_errors['titulo'][0]);  } ?> </p>
        </div>

        <div class="form-group">
          <label for="sucursal">Descripcion</label>
          <textarea type="text" name="descripcion" id="descripcion" class="form-control"><?php if (isset($_old_input['descripcion'])) {
...
?>
        ...
        <div class="form-group">
          ...
          <select id="estado" name="estado" class="form-control">
            ...
            <option value="1" <?php  if($_old_input['estado'] == 1 ){echo 'selected'; } ?>>Activo</option>
            <option value="2" <?php  if($_old_input['estado'] == 2 ){echo 'selected'; } ?>>Inactivo</option>
            <option value="3" <?php  if($_old_input['estado'] == 3 ){echo 'selected'; } ?>>Pendiente</option>
