...
?>">
    ...
    <form method="post" action="abmcafeterias/cargar"  enctype="multipart/form-data">
      ...
      echo($_old_input['nombre']);
        ...
        <p  class="error" ><?php if (isset($_errors['nombre'][0])) {
      ...
      echo($_old_input['direccion']);
        ...
        <p  class="error"><?php if (isset($_errors['direccion'][0])) {
      ...
      echo($_old_input['sucursal']);
        ...
        <p  class="error"><?php if (isset($_errors['sucursal'][0])) {
      ...
      echo($_old_input['telefono']);
        ...
        <p  class="error"><?php if (isset($_errors['telefono'][0])) {
      ...
      echo($_old_input['email']);
        ...
        <p  class="error"><?php if (isset($_errors['email'][0])) {
      ...
      <div class="form-group">
        ...
        <input type="text" name="sitio" id="sitio" value="<?php if (isset($_old_input['sitio'])) {
      echo($_old_input['email']);
  } ?>" class="form-control" />
        <p  class="error"><?php if (isset($_errors['sitio'][0])) {
      ...
      echo($_old_input['imagen']);
        ...
        <p  class="error"><?php if (isset($_errors['imagen'][0])) {
...
foreach ($cafeterias as $row) {
        ...
        echo("<td><a href='abmcafeterias/editar/" . $row->id . "' class='login-button btn btn-default boton2'>EDITAR</a></td>");
        echo("<td><input type='button' value ='Descativar' class='eliminar boton' id='$row->id' ></td>");
